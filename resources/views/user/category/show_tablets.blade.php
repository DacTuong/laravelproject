        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-12" style="padding-bottom: 12px;">
                <div class="product-content">
                    ...
                    <a class="link-product" href="{{ URL::to('/detail-product'.'/' . $tablet->product_id) }}">
                    ...
                    <div class="product__price--percent">
                        <p class="product__price--percent-detail">
                            @php
                            $percent_discount = (($tablet->old_price - $tablet->sale_price) / $tablet->old_price)
                            *
                            100;
                    ...
                    <form>
                        ...
                        <div class="action-buttons">
                            <button type="button" class="add-to-cart" data-id_product="{{ $tablet->product_id }}"
                                name="add-to-cart">
