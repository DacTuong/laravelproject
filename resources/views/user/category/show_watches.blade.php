        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-12" style="padding-bottom: 12px;">
                <div class="product-content">
                    ...
                    <a class="link-product" href="{{ URL::to('/detail-product'.'/' . $watch->product_id) }}">
                    ...
                    <div class="product__price--percent">
                        <p class="product__price--percent-detail">
                            @php
                            $percent_discount = (($watch->old_price - $watch->sale_price) / $watch->old_price)
                            *
                            100;
                    ...
                    <form>
                        ...
                        <input type="hidden" value="{{ $watch->color }}" class="product_color_{{ $watch->product_id }}">
                        <input type="hidden" value="1" class="cart_product_qty_{{ $watch->product_id }}">
                        <div class="action-buttons">
                            <button type="button" class="add-to-cart" data-id_product="{{ $watch->product_id }}"
                                name="add-to-cart">
