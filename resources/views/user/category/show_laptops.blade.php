        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-12" style="padding-bottom: 12px;">
                <div class="product-content">
                    ...
                    <a class="link-product" href="{{ URL::to('/detail-product'.'/' . $laptop->product_id) }}">
                    ...
                    <div class="product__price--percent">
                        <p class="product__price--percent-detail">
                            @php
                            $percent_discount = (($laptop->old_price - $laptop->sale_price) / $laptop->old_price)
                            *
                            100;
                    ...
                    <form>
                        ...
                        <div class="action-buttons">
                            <button type="button" class="add-to-cart" data-id_product="{{ $laptop->product_id }}"
                                name="add-to-cart">
