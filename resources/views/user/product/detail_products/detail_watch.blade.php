        ...
        <div class="policy">
            ...
            <ul class="policy__list">
                <li>
                    ...
                    <p>Sản phẩm sẽ được bảo hành và đổi mới trong vòng {{ $product->warranty_period }} tháng <a href="">Xem chi tiết</a></p>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="box-right">
            <div class="box-product-variants">
                ...
                <div class="box-product-option color">
                    ...
                    <div class="list-option" id="option-color">
                        ...
                        @php
                        $isActColor =
                        $color->smartwatch->watch_color == $product->smartwatch->watch_color
                        ? 'selected'
                        : '';
                        @endphp
            ...
            <div class="block-button allowbuy">
                <form>
                    ...
                    <input type="hidden" value="{{ $product->smartwatch->color }}"
            ...
            <div class="product-content">
                ...
                <div class="action-buttons">
                    <form>
                        ...
                        <input type="hidden" value="{{ $similar->smartwatch->watch_color }}"
    ...
    <div class="block-content-product row">
        <div class="col-sm-8">
            <div class="block-review">
                ...
                <div class="boxReview-review">
                    ...
                    <div class="boxReview-star">
                        ...
                        <div class="rating-level" data-rating_level="4">
                            ...
                            <div class="progress">
                                <div class="progress-bar" role="progressbar" style="  background-color: #f59e0b;" aria-valuemin="0" aria-valuemax="100">
                                </div>
                            </div>
                            <!-- <progress class="progress" role="progressbar" max="100" value="20"></progress> -->
                            <span class="rating-count"> </span>
                        ...
                        <div class="rating-level" data-rating_level="2">
                            ...
                            <div class="progress">
                                <div class="progress-bar" role="progressbar" style="  background-color: #f59e0b;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">
                                </div>
                            </div>
                            <!-- <progress class="progress" role="progressbar" max="100" value="20"></progress> -->
                            <span class="rating-count"></span>
                    ...
                    <div class="review-form-popup" id="review-form-popup">
                        ...
                        <div class="review-infor">
                            <div class="img">
                                <img src="{{ URL::to('uploads/product/' . $product->product_image) }}" class="thumbnail-img-review">
                            </div>
                        ...
                        <form class="form-group">
                            ...
                            <div class="text-review">
                                ...
                                <textarea placeholder="Mời nhập cảm nhận về sản phẩm" class="custom-textarea form-control" data-input-value="review" id="review" style="height: 120px;"></textarea>
                            </div>

                            <div class="dcap"><button type="button" class="send-review" data-id_product="{{ $product->product_id }}">Gửi đánh giá</button></div>
                        </form>
                    </div>
                </div>
                ...
                <a class="button__view-more-review" href="{{ URL::to('/review-product' . '/' . $product->product_id) }}">
                    Xem thêm
                </a>
            </div>
                    ...
                    <div class="box-specifi">
                        <ul class="text-specifi active">
                            <li>
                                ...
                                <aside>
                                    <span>{{ $product->smartwatch->watch_screen_size }}</span>
                                </aside>
                            </li>
                            <li>
                                <aside><strong>Công nghệ màn hình</strong></aside>
                                <aside>
                                    <span>{{ $product->smartwatch->watch_screen_type }}</span>
                                </aside>
                            </li>
                            <li>
                                <aside><strong>Thiết kế màn hình</strong></aside>
                                <aside>
                                    <span>{{ $product->smartwatch->watch_face_design }}</span>
                                </aside>
                            </li>
                            <li>
                                <aside><strong>Trọng lượng</strong></aside>
                                <aside>
                                    <span>{{ $product->smartwatch->watch_weight }}</span>
                                </aside>
                            </li>
                            <li>
                                <aside><strong>Dung lượng pin</strong></aside>
                                <aside>
                                    <span>{{ $product->smartwatch->watch_battery_life }}</span>
                                </aside>
                            </li>
...
<div class="specifications-popup" id="specifications-popup">
    ...
    <div class="specifications-popup-content">
        <div class="box-specifi">
            ...
            <ul class="text-specifi active">
                ...
                <li>
                    ...
                    <aside>
                        <span>{{ $product->smartwatch->watch_resolution }}</span>
                    </aside>
                </li>
                <li>
                    <aside><strong>Kích thước màn hình</strong></aside>
                ...
                <li>
                    <aside><strong>Thiết kế mặt đồng hồ</strong></aside>
                    <aside>
                        <span>{{ $product->smartwatch->watch_face_design }}</span>
                    </aside>
                </li>
        ...
        <div class="box-specifi">
            <a href="#" class="toggle-btn">Cấu hình</a>
            <ul class="text-specifi">
                <li>
                    <aside><strong>Hệ điều hành</strong></aside>
                    <aside>
                        <span>{{ $product->smartwatch->watch_operating_system }}</span>
                    </aside>
                </li>
                <li>
                    <aside><strong>Kết nối được với hệ điều hành</strong></aside>
                    <aside>
                        <span>{{ $product->smartwatch->watch_compatibility }}</span>
                    </aside>
                </li>
        ...
        <div class="box-specifi">
            ...
            <ul class="text-specifi">
                ...
                <li>
                    <aside><strong>Thời lượng pin</strong></aside>
                    <aside>
                        <span>{{ $product->smartwatch->watch_battery_life }}</span>
                    </aside>
                </li>
        ...
        <div class="box-specifi">
            ...
            <ul class="text-specifi">
                <li>
                    ...
                    <aside>
                        <span>{{ $product->smartwatch->watch_waterproof_rating }}</span>
                    </aside>
                </li>
                <li>
                    <aside><strong>Cảm biến</strong></aside>
                    <aside>
                        <span>{{ $product->smartwatch->watch_biometric_unlock }}</span>
                    </aside>
                </li>
            </ul>
        </div>
        <div class="box-specifi">
            <a href="#" class="toggle-btn">Tiện ích & kết nối</a>
            <ul class="text-specifi">
                <li>
                    <aside><strong>Cảm biến sức khỏe</strong></aside>
                    <aside>
                        <span>{{ $product->smartwatch->watch_health_sensors }}</span>
                    </aside>
                </li>
                <li>
                    <aside><strong>Kết nối khác</strong></aside>
                    <aside>
                        <span>{{ $product->smartwatch->watch_connectivity }}</span>
                    </aside>
                </li>
                <li>
                    <aside><strong>Định vị GPS</strong></aside>
                    <aside>
                        <span>{{ $product->smartwatch->watch_gps }}</span>
                    </aside>
                </li>
            </ul>
        </div>
