                    ...
                    <div class="box-product-option color">
                        ...
                        <div class="list-option" id="option-color">
                            @foreach ($colors as $color)
                                @php
                                    $isActColor =
                                        $color->detail_phone->color == $product->detail_phone->color ? 'selected' : '';
                                @endphp
            ...
            <div class="box-specifi">
                ...
                <ul class="text-specifi">
                    ...
                    <li>
                        ...
                        <aside>
                            <span>
                                @if ($product->detail_phone->expandable_storage == false)
            ...
            <div class="box-specifi">
                ...
                <ul class="text-specifi">
                    ...
                    <li>
                        ...
                        <aside>
                            <span>
                                @if ($product->detail_phone->fast_charging == true)
                                    Có hỗ trợ sạc nhanh
                                @else
                    ...
                    <li>
                        ...
                        <aside>
                            <span>
                                @if ($product->detail_phone->wireless_charging == true)
