        ...
        <div class="box-right">
            ...
            <div class="box-product-variants">
                ...
                <div class="box-product-option color">
                    ...
                    <div class="list-option" id="option-color">
                        ...
                        @php
                        $isActColor =
                        $color->tablet->tablet_color == $product->tablet->tablet_color
                        ? 'selected'
                        : '';
                        @endphp
            ...
            <div class="block-button allowbuy">
                <form>
                    ...
                    <input type="hidden" value="{{ $product->tablet->tablet_color }}"
                    ...
                    <div class="box-specifi">
                        <ul class="text-specifi active">
                            <li>
                                ...
                                <aside>
                                    <span>{{ $product->tablet->tablet_screen_type }}</span>
                                </aside>
                            </li>
                            <li>
                                <aside><strong>Chip xứ lý (CPU)</strong></aside>
                                <aside>
                                    <span>{{ $product->tablet->tablet_cpu }}</span>
                                </aside>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <aside>
                                    <span>{{ $product->tablet->tablet_resolution }}</span>
                                </aside>
                            </li>
                            <li>
                                <aside><strong>Màn hình rộng</strong></aside>
                                <aside>
                                    <span>{{ $product->tablet->tablet_screen_size }}</span>
                                </aside>
                            </li>
                            <li>
                                <aside><strong>Tần số quét</strong></aside>
                                <aside>
                                    <span>{{ $product->tablet->tablet_refresh_rate }} hz</span>
                                </aside>
                            </li>
                            <li>
                                <aside><strong>RAM</strong></aside>
                                <aside>
                                    <span>{{ $product->tablet->tablet_ram }}</span>
                                </aside>
                            </li>
                            <li>
                                <aside><strong>Bộ nhớ trong</strong></aside>
                                <aside>
                                    <span>{{ $product->tablet->tablet_storage }}</span>
                                </aside>
                            </li>
...
<div class="specifications-popup" id="specifications-popup">
    ...
    <div class="specifications-popup-content">
        <div class="box-specifi">
            ...
            <ul class="text-specifi active">
                ...
                <li>
                    <aside><strong>Tần số quét</strong></aside>
                    <aside>
                        <span>{{ $product->tablet->tablet_refresh_rate }}</span>
                    </aside>
                </li>
            </ul>
        </div>
        ...
        <div class="box-specifi">
            <a href="#" class="toggle-btn">Hệ điều hành & CPU</a>
            <ul class="text-specifi">
                <li>
                    <aside><strong>Hệ điều hành</strong></aside>
                    <aside>
                        <span>{{ $product->tablet->tablet_operating_system }}</span>
                    </aside>
                </li>
                <li>
                ...
                <li>
                    <aside><strong>Chip đồ họa (GPU)</strong></aside>
                    <aside>
                        <span>{{ $product->tablet->tablet_gpu }}</span>
                    </aside>
                </li>
        ...
        <div class="box-specifi">
            ...
            <ul class="text-specifi">
                <li>
                    <aside><strong>ram</strong></aside>
                    <aside>
                        <span>{{ $product->tablet->tablet_ram }} GB</span>
                    </aside>
                </li>
                <li>
                    <aside><strong>Bộ nhớ trong</strong></aside>
                    <aside>
                        <span>{{ $product->tablet->tablet_storage }} GB</span>
                    </aside>
                </li>
                <li>
                    ...
                    <aside>
                        <span>
                            {{ $product->tablet->tablet_expandable_storage }}
                        </span>
                    </aside>
                </li>
            </ul>
        ...
        <div class="box-specifi">
            <a href="#" class="toggle-btn">Camera sau</a>
            <ul class="text-specifi">
                <li>
                    <aside><strong>Độ phân giải</strong></aside>
                    <aside>
                        <span>{{ $product->tablet->tablet_camera_rear }}</span>
                    </aside>
                </li>
                <li>
                    <aside><strong>Quay phim</strong></aside>
                    <aside>
                        <span>{{ $product->tablet->tablet_camera_rear_recording }}</span>
                    </aside>
                </li>
                <li>
                    ...
                    <aside>
                        <span>
                            {{ $product->tablet->tablet_camera_rear_feature }}
                        </span>
                    </aside>
                </li>
            </ul>
        ...
        <div class="box-specifi">
            <a href="#" class="toggle-btn">Camera trước</a>
            <ul class="text-specifi">
                <li>
                    <aside><strong>Độ phân giải</strong></aside>
                    <aside>
                        <span>{{ $product->tablet->tablet_camera_front }}</span>
                    </aside>
                </li>
                ...
                <li>
                    ...
                    <aside>
                        <span>
                            {{ $product->tablet->tablet_camera_front_feature }}
                        </span>
                    </aside>
                </li>
            </ul>
        ...
        <div class="box-specifi">
            ...
            <ul class="text-specifi">
                <li>
                    ...
                    <aside>
                        <span>{{ $product->tablet->tablet_battery_capacity }} mAh</span>
                    </aside>
                </li>
                <li>
                    ...
                    <aside>
                        <span>
                            {{ $product->tablet->tablet_fast_charging }}
                        </span>
                    </aside>
                </li>
        ...
        <div class="box-specifi">
            ...
            <ul class="text-specifi">
                <li>
                    ...
                    <aside>
                        <span>{{ $product->tablet->tablet_water_resistance }}</span>
                    </aside>
                </li>
        ...
        <div class="box-specifi">
            ...
            <ul class="text-specifi">
                <li>
                    ...
                    <aside>
                        <span>
                            {{ $product->tablet->tablet_charging_port }}
                        </span>
                    </aside>
                </li>
                <li>
                    ...
                    <aside>
                        <span>{{ $product->tablet->tablet_connectivity }}</span>
                    </aside>
                </li>
        ...
        <div class="box-specifi">
            <a href="#" class="toggle-btn">Thiết kê & Trọng lượng</a>
            <ul class="text-specifi">
                <li>
                    <aside><strong>Kích thước</strong></aside>
                    <aside>
                        <span>
                            {{ $product->tablet->tablet_dimensions }}
                        </span>
                    </aside>
                </li>
                <li>
                    ...
                    <aside>
                        <span>{{ $product->tablet->tablet_weight }}</span>
                    </aside>
                </li>
